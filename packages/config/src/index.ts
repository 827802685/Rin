...
export const CLIENT_CONFIG_DEFAULTS = new Map(
  Object.entries({
    ...
    "site.avatar": "",
    "site.page_size": 5,
    "widget.live2d.enabled": false,
    "widget.live2d.position": "right",
    "widget.live2d.model": "https://raw.githubusercontent.com/827802685/Rin/main/client/public/models/furina/furina.model3.json",
    ...
    "widget.cursor.text": "/cursors/furina/text.png",
    "widget.firework.enabled": false,
    "widget.firework.disable_on_mobile": true,
    ...
    "widget.anchor.auto": true,
    "widget.anchor.length": 60,
  }),
);
